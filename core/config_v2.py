...
__C.YOLO.CLASSES                = "./data/classes/open_image_v2.names"
...
__C.TRAIN.ANNOT_PATH            = "./data/dataset/open_image_train_v2.txt"
...
__C.TEST.ANNOT_PATH             = "./data/dataset/open_image_test_v2.txt"
__C.TEST.BATCH_SIZE             = 2
__C.TEST.INPUT_SIZE             = 544
__C.TEST.DATA_AUG               = False
__C.TEST.WRITE_IMAGE            = True
__C.TEST.WRITE_IMAGE_PATH       = "./data/detection/open_image"
__C.TEST.WRITE_IMAGE_SHOW_LABEL = False
#__C.TEST.WEIGHT_FILE            = "./checkpoint/yolov3_test_loss=9.2099.ckpt-5"
__C.TEST.WEIGHT_FILE            = "./checkpoint/yolov3_test_loss=1.9817.ckpt-25"
