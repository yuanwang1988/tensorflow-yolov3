...
# v3 considers multiple classes that could appear on the street
label_name_to_class_id_dict = {
    '/m/01jfm_': 0,  # Vehicle Registration Plate
    '/m/0k4j': 1,  # Car
    '/m/02pv19': 2,  # Stop Sign
    '/m/033rq4': 3,  # Street Light
    '/m/07r04': 4,  # Truck
    '/m/083wq': 5,  # Wheel
    '/m/01mqdt': 6,  # Traffic sign
...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_annotation", default="./data/dataset/open_image_train_v3.txt")
    # parser.add_argument("--validation_annotation", default="./data/dataset/open_image_validation_v3.txt")
    parser.add_argument("--test_annotation", default="./data/dataset/open_image_test_v3.txt")
